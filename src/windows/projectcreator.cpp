...
namespace RMG {
	INT InitProjectCreator(FWindowGuiInfo& windowInfo)
	{
		...
		HWND window = CreateWindow(wc.lpszClassName, L"RGG Project Creator", WS_BORDER | WS_OVERLAPPED | WS_SYSMENU | WS_CAPTION | WS_MINIMIZEBOX, 100, 125, (GetSystemMetrics(SM_CXSCREEN)/3), (GetSystemMetrics(SM_CYSCREEN)/1.5), NULL, NULL, windowInfo.instance, NULL);
		...
		RMG::GUIProjectCreatorWindow guiWindow{};
		...
		*/
		...
		int obby_button_width = 0;
		int obby_button_height = 0;
		ID3D11ShaderResourceView* obby_button_texture = NULL;
		bool ret = LoadTextureFromFile("C:\\Users\\kappa\\Documents\\VS 2022\\Projects\\RobloxMG\\assets\\buttons\\obbybutton.png", &obby_button_texture, &obby_button_width, &obby_button_height, device);
		IM_ASSERT(ret);

		guiWindow.obby_button_texture = obby_button_texture;
